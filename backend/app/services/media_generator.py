...
class MediaGenerator:
    ...
    def create_video_from_image(self, image_path: str, duration: int = 5) -> str:
        """
        ...
        if not ImageSequenceClip:
            print("MoviePy not installed or failed to import.")
            return None
        ...
        try:
            ...
            fd, out_path = tempfile.mkstemp(suffix=".mp4", dir=str(self.media_dir))
    ...
    def get_public_url(self, file_path: str) -> str:
        ...
        if public_url:
            ...
            return f"{public_url}/static/media/{filename}"
            
        # Default to localhost
        return f"http://127.0.0.1:8080/static/media/{filename}"
